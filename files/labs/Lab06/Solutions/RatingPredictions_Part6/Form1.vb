Public Class frmRatingPredictions
    ...
    Private Sub btnPredictRatings_Click(sender As Object, e As EventArgs) Handles btnPredictRatings.Click
        ...
        outResults.Text = "The most similar viewer was viewer #" & (originalUserID(0) + 1) & " and the distance calculated was " & FormatNumber(distances(0), 1) & "." & vbNewLine
        outResults.AppendText("The predicted rating for movie five is " & FormatNumber(viewerRatings5(originalUserID(0))) & ".")
    End Sub
