Public Class frmVideoRentalStore
    ...
    Private Sub btnComputeTotal_Click(sender As Object, e As EventArgs) Handles btnComputeTotal.Click
        ...
        Dim numberOfRegularVideos As Integer = 0, numberOfPremiumVideos As Integer = 0, numberOfDays As Integer = 0, numberOfCandyBars As Integer = 0, numberOfBagsOfPopcorn As Integer = 0, numberOfCansOfSoda As Integer = 0
        ...
        numberOfCansOfSoda = txtNumberOfCansOfSoda.Text
